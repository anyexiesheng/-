...
<div id="theme-page" <?php echo get_schema_markup('main'); ?>>
	...
	<?php } elseif ( $post_type == 'video' ) {
        ...
        if($video_site =='youku') {
				echo '<div class="mk-portfolio-video"><div class="mk-video-container"><iframe src="http'.((is_ssl())? 's' : '').'://player.youku.com/embed/'.$video_id.'" width="'.$image_width.'" height="'.$image_height.'" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div></div>';
				}

				if($video_site =='tudou') {
				echo '<div class="mk-portfolio-video"><div class="mk-video-container"><iframe src="http'.((is_ssl())? 's' : '').'://www.tudou.com/programs/view/html5embed.action?code='.$video_id.'" width="'.$image_width.'" height="'.$image_height.'" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div></div>';
				}

				if($video_site =='wule') {
				echo '<div class="mk-portfolio-video"><div class="mk-video-container"><iframe src="http'.((is_ssl())? 's' : '').'://www.56.com/iframe/'.$video_id.'?title=0&amp;byline=0&amp;portrait=0&amp;color='.str_replace("#", "", $skin_color).'" width="'.$image_width.'" height="'.$image_height.'" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div></div>';
				}

				if($video_site =='vqq') {
				echo '<div class="mk-portfolio-video"><div class="mk-video-container"><iframe src="http'.((is_ssl())? 's' : '').'://v.qq.com/iframe/player.html?vid='.$video_id.'" width="'.$image_width.'" height="'.$image_height.'" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div></div>';
				}
