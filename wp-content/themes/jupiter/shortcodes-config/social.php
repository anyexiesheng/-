...
vc_map(array(
    "name" => __("百度地图", "mk_framework"),
    "base" => "mk_bmap",
    'icon' => 'icon-mk-advanced-google-maps vc_mk_element-icon',
    'description' => __( '百度地图国人更需要.', 'js_composer' ),
    "category" => __('Social', 'mk_framework'),
    "params" => array(
        
        array(
            "type" => "textfield",
            "heading" => __("地图ID", "mk_framework"),
            "param_name" => "id",
            "value" => "",
            "description" => __('例如abcd', "mk_framework")
        ),
        array(
            "type" => "textfield",
            "heading" => __("地图宽度", "mk_framework"),
            "param_name" => "w",
            "value" => "",
            "description" => __('例如 : 100%', "mk_framework")
        ),
        array(
            "type" => "textfield",
            "heading" => __("地图高度", "mk_framework"),
            "param_name" => "h",
            "value" => "",
            "description" => __('例如：400px', "mk_framework")
        ),
        
        array(
            "type" => "textfield",
            "heading" => __("经度", "mk_framework"),
            "param_name" => "lon",
            "value" => "",
            "description" => __('', "mk_framework")
        ),
        array(
            "type" => "textfield",
            "heading" => __("纬度", "mk_framework"),
            "param_name" => "lat",
            "value" => "",
            "description" => __('如', "mk_framework")
        ),
        array(
            "type" => "textfield",
            "heading" => __("公司名称", "mk_framework"),
            "param_name" => "biz_name",
            "value" => "",
            "description" => __('如点金主题网', "mk_framework")
        ),
