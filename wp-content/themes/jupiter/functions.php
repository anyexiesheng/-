...
function dj_remove_open_sans_from_wp_core() {
    wp_deregister_style( 'open-sans' );
    wp_register_style( 'open-sans', false );
    wp_enqueue_style('open-sans','');
}
add_action( 'init', 'dj_remove_open_sans_from_wp_core' );
...
class Theme
{
    ...
    function supports() {
        ...
        register_nav_menus(array(
            ...
            'sixth-menu' => '第六导航',
            'footer-menu' => '页脚导航',
            'toolbar-menu' => '页眉工具栏导航',
            'side-dashboard-menu' => '侧边面板导航',
            'fullscreen-menu' => '全屏导航'
        ));
    ...
    function admin_menus() {
        ...
        // ));
         ...
         //add_submenu_page('themes.php', '安装模板', '安装模板', 'manage_options', 'install-template', array(&$this,
       ...
       // ) , 'dashicons-lock', 3);
        ...
        // add_submenu_page( 'register-product', '欢迎', '欢迎', 'manage_options', 'welcome', array(&$this,
        //    '_welcome_page'
       // ) );
