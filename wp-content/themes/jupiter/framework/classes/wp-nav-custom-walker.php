        ...
        <li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode(' ', $classes ); ?>">
            ...
            <div class="menu-item-settings" id="menu-item-settings-<?php echo $item_id; ?>">
                ...
                <label for="edit-menu-item-target-<?php echo $item_id; ?>">
                        ...
                        <span class="description"><?php _e("<a target='_blank' href='".admin_url( 'tools.php?page=icon-library')."'>单击这里</a>获取图标类名称(或任何安装在主题中的其它字体图标)", "mk_framework"); ?></span>
                </label>
                </p>
 ...
 * @return      void
*/
class mk_artbees_walker extends Walker_Nav_Menu {
    /**
         * @var int $columns 
         */
        var $columns = 0;
