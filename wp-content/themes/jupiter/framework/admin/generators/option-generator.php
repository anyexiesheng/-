...
<?php
    ...
    function start( $value ) {
        ...
        echo '<span class="masterkey-branding"><a href="#" alt="" title="" class="mk-logo"></a><span title="Theme Version" class="mk-theme-version">ver '.$theme_data['Version'].'<br>点金主题网汉化</span></span>';
...
-------------------------------------------------------------*/
    function header_social_networks( $value ) {
        ...
        echo '<span class="header-social-option-row"><span class="header-social-option-label">选择一个站点</span><div class="mk-fancy-selectbox text-based" id="header_social_sites" style="width:320px">';
...
-------------------------------------------------------------*/
    function sys_diagnose( $value ) {
        ...
        echo '</ul></div>';
        echo '<a href="http://artbees.net/themes/support/jupiter" style="margin-left:0;" target="_blank" class="mk-button dominant-color mk-secondary">Help Desk</a>';
        echo '</div>';
    }
...
*/
    function get_select_target_options( $type ) {
        ...
        switch ( $type ) {
        case 'page':
            $entries = get_pages( 'title_li=&orderby=name&number=30' );
