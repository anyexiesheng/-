...
*/
$config = array(
	'title' => sprintf('%s员工选项', THEME_NAME) ,
...
$options = array(
	...
	array(
		"name" => __("Header Hero Background Image (Specific to style 3)", "mk_framework") ,
		"desc" => __("Upload an image for single post > style 3 layout > header hero background image. Best image size for this field is 1920px * 550px", "mk_framework") ,
	...
	array(
		"name" => __('Header Hero Background Color (Specific to style 3)', 'mk_framework') ,
		"desc" => __("choose a color for single post > style 3 layout > header hero background color.", "mk_framework") ,
	...
	array(
		"name" => __("Header Hero Content Skin (Specific to style 3)", "mk_framework") ,
