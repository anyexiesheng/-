...
$theme_options_general = array(
	...
	array(
		...
		"desc" => __("请选择菜单位置，这个显示给登录用户的全局主导航。您首先应该 <a target='_blank' href='" . admin_url('nav-menus.php') . "'>创建菜单</a>，然后 <a target='_blank' href='" . admin_url('nav-menus.php') . "?action=locations'>分配菜单位置</a>", "mk_framework"),
		"id" => "loggedin_menu",
