...
function register_mk_icon_library() {
	add_submenu_page('tools.php', '图标库', '图标库', 'manage_options', 'icon-library', 'icon_library_submenu_page_callback');
}
...
function mk_enqueue_icon_lib() {
	...
	wp_enqueue_style('mk-icon-libs', THEME_ADMIN_ASSETS_URI . '/stylesheet/css/icon-library.min.css', false, $theme_data['Version'], 'all');
