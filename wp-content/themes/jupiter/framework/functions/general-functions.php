...
?>
    ...
    <table class="form-table">
	    <tr>
            ...
            <td>
                <input type="text" name="weibo" id="weibo" value="<?php
          echo esc_attr(get_the_author_meta('weibo', $user->ID));
?>" class="regular-text" /><br />
                <span class="description">请输入新浪微博链接地址.</span>
            </td>
        </tr>
		<tr>
            <th><label for="weixin">微信</label></th>

            <td>
                <input type="text" name="weixin" id="weixin" value="<?php
          echo esc_attr(get_the_author_meta('weixin', $user->ID));
?>" class="regular-text" /><br />
                <span class="description">请输入微信二维码地址.</span>
            </td>
        </tr>
...
?>" class="regular-text" /><br />
                <span class="description">请输入Twitter资料地址.</span>
            </td>
        </tr>
