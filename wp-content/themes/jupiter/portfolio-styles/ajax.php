        ...
        while ($r->have_posts()):
            ...
            if ($mk_options['single_portfolio_social'] == 'true'):
                ...
                $html .= '<ul class="single-share-box mk-box-to-trigger">';
                 $html .= '<li><a class="weibo-share" href="http://www.jiathis.com/send/?webid=tsina&url='.get_permalink().'&title='.get_the_title().'" target="_blank"><i class="mk-jupiter-icon-simple-weibo"></i></a></li>';
            $html.= '<li><a class="wenxin-share" href="http://www.jiathis.com/send/?webid=weixin&url='.get_permalink().'&title='.get_the_title().'" target="_blank"><i class="mk-jupiter-icon-simple-weixin"></i></a></li>';
            $html .= '<li><a class="qzone-share" href="http://www.jiathis.com/send/?webid=qzone&url='.get_permalink().'&title='.get_the_title().'" target="_blank"><i class="mk-jupiter-icon-simple-qzone"></i></a></li>';
            $html.= '<li><a class="renren-share" href="http://www.jiathis.com/send/?webid=renren&url='.get_permalink().'&title='.get_the_title().'" target="_blank"><i class="mk-jupiter-icon-simple-renren"></i></a></li>';
            ...
            if ($featured_image != 'false') {
                if ($post_type == 'image') {
					...
					if ($video_site == 'youku') {
                        $html .= '<div class="mk-portfolio-video"><div class="mk-video-container"><iframe src="http' . ((is_ssl()) ? 's' : '') . '://player.youku.com/embed/' . $video_id . '" width="' . $image_width . '" height="' . $image_height . '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div></div>';
                    }

					if ($video_site == 'tudou') {
                        $html .= '<div class="mk-portfolio-video"><div class="mk-video-container"><iframe src="http' . ((is_ssl()) ? 's' : '') . '://www.tudou.com/programs/view/html5embed.action?code=' . $video_id . '" width="' . $image_width . '" height="' . $image_height . '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div></div>';
                    }

					if ($video_site == 'wule') {
                        $html .= '<div class="mk-portfolio-video"><div class="mk-video-container"><iframe src="http' . ((is_ssl()) ? 's' : '') . '://www.56.com/iframe/' . $video_id . '" width="' . $image_width . '" height="' . $image_height . '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div></div>';
                    }

					if ($video_site == 'vqq') {
                        $html .= '<div class="mk-portfolio-video"><div class="mk-video-container"><iframe src="http' . ((is_ssl()) ? 's' : '') . '://v.qq.com/iframe/player.html?vid=' . $video_id . '" width="' . $image_width . '" height="' . $image_height . '" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div></div>';
                    }
