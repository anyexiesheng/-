	...
	<div class="theme-page-wrapper mk-blog-single <?php echo $single_layout; ?>-layout vc_row-fluid mk-grid <?php echo $padding; ?>">
		...
		<article id="<?php the_ID(); ?>" <?php post_class(); ?>>
            ...
            echo $output_portfolio;
				...
				if($video_site =='youku') {
				echo '<div style="width:'.$image_width.'px;" class="mk-video-wrapper"><div class="mk-video-container"><iframe src="http'.((is_ssl())? 's' : '').'://player.youku.com/embed/'.$video_id.'" width="'.$image_width.'" height="'.$image_height.'" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div></div>';
				}

				if($video_site =='tudou') {
				echo '<div style="width:'.$image_width.'px;" class="mk-video-wrapper"><div class="mk-video-container"><iframe src="http'.((is_ssl())? 's' : '').'://www.tudou.com/programs/view/html5embed.action?code='.$video_id.'" width="'.$image_width.'" height="'.$image_height.'" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div></div>';
				}

				if($video_site =='wule') {
				echo '<div style="width:'.$image_width.'px;" class="mk-video-wrapper"><div class="mk-video-container"><iframe src="http'.((is_ssl())? 's' : '').'://www.56.com/iframe/'.$video_id.'?title=0&amp;byline=0&amp;portrait=0&amp;color='.str_replace("#", "", $skin_color).'" width="'.$image_width.'" height="'.$image_height.'" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div></div>';
				}

				if($video_site =='vqq') {
				echo '<div style="width:'.$image_width.'px;" class="mk-video-wrapper"><div class="mk-video-container"><iframe src="http'.((is_ssl())? 's' : '').'://v.qq.com/iframe/player.html?vid='.$video_id.'" width="'.$image_width.'" height="'.$image_height.'" frameborder="0" webkitAllowFullScreen mozallowfullscreen allowFullScreen></iframe></div></div>';
				}
							...
							<div class="single-social-section">
								...
								<div class="blog-share-container">
									...
									<ul class="single-share-box mk-box-to-trigger">
										<li><a class="weibo-share" href="http://www.jiathis.com/send/?webid=tsina&url=<?php echo get_permalink(); ?>&title=<?php the_title(); ?>" target="_blank"><i class="mk-jupiter-icon-simple-weibo"></i></a></li>
										<li><a class="wenxin-share" href="http://www.jiathis.com/send/?webid=weixin&url=<?php echo get_permalink(); ?>&title=<?php the_title(); ?>" target="_blank"><i class="mk-jupiter-icon-simple-weixin"></i></a></li>
										<li><a class="qzone-share" href="http://www.jiathis.com/send/?webid=qzone&url=<?php echo get_permalink(); ?>&title=<?php the_title(); ?>" target="_blank"><i class="mk-jupiter-icon-simple-qzone"></i></a></li>
										<li><a class="renren-share" href="http://www.jiathis.com/send/?webid=renren&url=<?php echo get_permalink(); ?>&title=<?php the_title(); ?>" target="_blank"><i class="mk-jupiter-icon-simple-renren"></i></a></li>
						...
						<div class="mk-about-author-wrapper" <?php echo get_schema_markup('author_box'); ?>>
								...
								<ul class="about-author-social">
									...
									if(get_the_author_meta( 'weibo' )) {
										echo '<li><a class="weibo-icon" title="'.__('关注我的新浪微博','mk_framework').'" href="'.get_the_author_meta( 'weibo' ).'" target="_blank"><i class="mk-jupiter-icon-simple-weibo"></i></a></li>';
									}
									if(get_the_author_meta( 'weixin' )) {
										echo '<li><a class="weixin-icon mk-lightbox blog-modern-lightbox" data-fancybox-group="blog-modern" title="'.__('微信二维码，点击扫一扫','mk_framework').'" href="'.get_the_author_meta( 'weixin' ).'"><i class="mk-jupiter-icon-simple-weixin"></i></a></li>';
									}
