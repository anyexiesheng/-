...
class Artbees_Widget_Testimonials extends WP_Widget {
	...
	function Artbees_Widget_Testimonials() {
		$widget_ops = array( 'classname' => 'widget_testimonials', 'description' => '显示见证幻灯片.' );
		$this->WP_Widget( 'testimonial_widget', THEME_SLUG.' - '.'见证', $widget_ops );
...
<p>
<label for="<?php echo $this->get_field_id( $quote ); ?>"><?php printf( '#%s 引用:', $i );?></label>
...
<p>
<label for="<?php echo $this->get_field_id( $company ); ?>"><?php printf( '#%s 公司:', $i );?></label>
...
<p>
<label for="<?php echo $this->get_field_id( $src ); ?>"><?php printf( '#%s 作者图像地址:', $i );?></label>
<input class="widefat" id="<?php echo $this->get_field_id( $src ); ?>" name="<?php echo $this->get_field_name( $src ); ?>" type="text" value="<?php echo $$src; ?>" />
</p>

<p>
<label for="<?php echo $this->get_field_id( $url ); ?>"><?php printf( '#%s 作者网站地址:', $i );?></label>
<input class="widefat" id="<?php echo $this->get_field_id( $url ); ?>" name="<?php echo $this->get_field_name( $url ); ?>" type="text" value="<?php echo $$url; ?>" />
</p>

<p>
<label for="<?php echo $this->get_field_id( $position ); ?>"><?php printf( '#%s 职位:', $i );?></label>
