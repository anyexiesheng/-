...
class Artbees_Widget_Sub_Navigation extends WP_Widget {
	...
	function Artbees_Widget_Sub_Navigation() {
		$widget_ops = array( 'classname' => 'widget-sub-navigation', 'description' => '显示子页面列表' );
		$this->WP_Widget( 'subnav', THEME_SLUG.' - '. '子导航', $widget_ops );
	}
...
?>
		...
		<p>
			...
			<br />
			<small>页面IDs, 半角逗号分开 (例如: 12,34,543,98)<?php _e('Page IDs, Separate with a comma (eg: 12,34,543,98)', 'mk_framework'); ?></small>
		</p>
<?php
	}
