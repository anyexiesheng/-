...
<div id="ls-screen-options" class="metabox-prefs hidden">
	<div id="screen-options-wrap" class="hidden">
		<form id="ls-screen-options-form" action="<?php echo $_SERVER['REQUEST_URI']?>" method="post">
			...
			<label>
				<input type="checkbox" name="showTooltips"<?php echo $lsScreenOptions['showTooltips'] == 'true' ? ' checked="checked"' : ''?>> 工具提示
			</label>
		</form>
	</div>
...
<div id="ls-share-template" class="ls-modal ls-box">
	...
	<div class="inner">
		<a href="https://www.facebook.com/sharer/sharer.php?u=http://kreaturamedia.com/layerslider-responsive-wordpress-slider-plugin/" target="_blank">
			<i class="dashicons dashicons-facebook-alt"></i> 分享
		</a>
	...
	<div id="ls-pages">
		...
		<div class="ls-page <?php echo $slidesTabClass ?>">
			...
			<div id="ls-layer-tabs">
				...
				<a href="#" class="<?php echo $active ?>">幻灯片 #<?php echo ($key+1) ?><span class="dashicons dashicons-dismiss"></span></a>
				<?php endforeach; ?>
				...
				<div class="ls-box ls-layer-box <?php echo $active ?>">
					<table>
						...
						<tbody class="ls-slide-options">
							...
							<tr>
								<td valign="top">
									<h3 class="subheader">幻灯片图像 &amp; 缩略图</h3>
								...
								<td valign="top" class="second">
									<h3 class="subheader">持续时长</h3>
									<?php lsGetInput($lsDefaults['slides']['delay'], $layerProps, array('class' => 'layerprop')) ?> 毫秒
									<h3 class="subheader">
										转场
									</h3>
									<button type="button" class="button ls-select-transitions new" data-help="<?php _e('You can select your desired slide transitions by clicking on this button.', 'LayerSlider') ?>">选择转场</button><br><br>
									<?php echo $lsDefaults['slides']['timeshift']['name'] ?><br>
									<?php lsGetInput($lsDefaults['slides']['timeshift'], $layerProps, array('class' => 'layerprop')) ?> 毫秒
								</td>
								<td valign="top">
									<h3 class="subheader">链接</h3>
									<div class="ls-slide-link">
										...
										<span> 或 <a href="#"><?php _e('use post URL', 'LayerSlider') ?></a></span>
									</div>
									<h3 class="subheader">杂项</h3>
								...
								<td>
									...
									<h4>
										...
										<div class="ls-editor-zoom">
											<span class="ls-editor-slider-text">大小:</span>
												...
												<div class="ls-layer-sections">
													...
													<div class="ls-image-uploader slide-image clearfix ls-hidden">
														...
														<p>
															...
															<a href="#" class="ls-url-prompt"><?php _e('insert from URL', 'LayerSlider') ?></a> 或
													...
													<div class="ls-html-code">
														<textarea name="html" cols="50" rows="5" placeholder="输入图层内容" data-help="<?php _e('Type here the contents of your layer. You can use any HTML codes in this field to insert content others then text. This field is also shortcode-aware, so you can insert content from other plugins as well as video embed codes.', 'LayerSlider') ?>"><?php echo stripslashes($sublayer['html']) ?></textarea>
														<p class="ls-hidden">
												...
												<table>
													<tbody>
														<tr>
															...
															<td><?php lsGetInput($lsDefaults['layers']['transitionInDuration'], $sublayer, array('class' => 'sublayerprop')) ?> 毫秒</td>
															<td class="right"><?php echo $lsDefaults['layers']['transitionInDelay']['name'] ?></td>
															<td><?php lsGetInput($lsDefaults['layers']['transitionInDelay'], $sublayer, array('class' => 'sublayerprop')) ?> 毫秒</td>
														...
														<tr>
															...
															<td><?php lsGetInput($lsDefaults['layers']['transitionOutDuration'], $sublayer, array('class' => 'sublayerprop')) ?> 毫秒</td>
															<td class="right"><?php echo $lsDefaults['layers']['showUntil']['name'] ?></td>
															<td><?php lsGetInput($lsDefaults['layers']['showUntil'], $sublayer, array('class' => 'sublayerprop')) ?> 毫秒</td>
