	...
	class UniteSettingsProductSidebarRev extends UniteSettingsOutputRev{
		...
		public function drawCssEditor(){
			...
			<div id="css_editor_wrap" title="<?php _e("Style Editor",REVSLIDER_TEXTDOMAIN) ?>" style="display:none;">
				...
				<div class="tp-present-wrapper-parent"><div class="tp-present-wrapper"><div class="tp-present-caption"><div id="css_preview" class="">示例</div></div></div></div>
				<ul class="list_idlehover">
					<li><a href="javascript:void(0)" id="change-type-idle" class="change-type selected"><span class="nowrap">空闲</span></a></li>
					<li><a href="javascript:void(0)" id="change-type-hover" class="change-type"><span class="nowrap">悬停</span></a></li>					
				...
				<div id="css-editor-accordion">
					...
					<div class="css_editor_novice_wrap">
						<table style="border-spacing:0px">
							...
							<tr class="css-edit-title"><td colspan="4">字体</td></tr>
							...
							<tr class="css-edit-title noborder"><td colspan="4"></td></tr>							
							<tr class="css-edit-title"><td colspan="4">背景</td></tr>
							<tr class="css-edit-title noborder"><td colspan="4"></td></tr>														
							<tr>
								<td><?php _e("Color:",REVSLIDER_TEXTDOMAIN) ?></td>
								<td>
							...
							<tr class="css-edit-title noborder"><td colspan="4"></td></tr>							
							<tr class="css-edit-title"><td colspan="4">边框</td></tr>
							<tr class="css-edit-title noborder"><td colspan="4"></td></tr>														
							<tr>
								<td><?php _e("Color:",REVSLIDER_TEXTDOMAIN) ?></td>
								<td>
