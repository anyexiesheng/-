 ...
 class UniteBaseAdminClassRev extends UniteBaseClassRev{
		...
		public static function addCommonScripts(){
			...
			if(GlobalsRevSlider::$isNewVersion){	//load new jquery ui library
				$urlJqueryUI = RevSliderAdmin::$url_plugin."js/1.10.1/jquery-ui.min.js";
				self::addScriptAbsoluteUrl($urlJqueryUI,"jquery-ui");
				
				//self::addStyle("jquery-ui-1.10.3.custom.min","jui-smoothness","css/jui/new");
				wp_enqueue_style('jui-smoothness', esc_url_raw(RevSliderAdmin::$url_plugin.'js/1.10.1/jquery-ui.css'), array(), null);
				...
				$urlJqueryUI = RevSliderAdmin::$url_plugin."js/1.8.18/jquery-ui.min.js";
				self::addScriptAbsoluteUrl($urlJqueryUI,"jquery-ui");
				//self::addStyle("jquery-ui-1.8.18.custom","jui-smoothness","css/jui/old");
				wp_enqueue_style('jui-smoothness', esc_url_raw(RevSliderAdmin::$url_plugin.'js/1.8.18/jquery-ui.css'), array(), null);
