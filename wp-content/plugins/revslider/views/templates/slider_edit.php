					...
					<div id="main_dlier_settings_wrapper" class="postbox unite-postbox ">
					  ...
					  <div class="p10">
							...
							<div id="layout-preshow">
								<strong>布局示例 </strong><span style="font-size:11px;font-style:italic;"><?php _e(" Can be different based on Theme Style",REVSLIDER_TEXTDOMAIN)?></span>
								<div class="divide20"></div>
								<div id="layout-preshow-page">
									<div class="layout-preshow-text">浏览器</div>
									<div id="layout-preshow-theme">
											<div class="layout-preshow-text">页面</div>
									</div>
									<div id="layout-preshow-slider">
											<div class="layout-preshow-text">幻灯片</div>
									</div>
									<div id="layout-preshow-grid">
											<div class="layout-preshow-text">图层网格</div>										
									</div>
								</div>
							</div>
