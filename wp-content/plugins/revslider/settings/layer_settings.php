<?php
	...
	$buttonEditStyles = UniteFunctionsRev::getHtmlLink("javascript:void(0)", "<i class=\"revicon-magic\"></i>编辑样式","button_edit_css","button-primary revblue");
	$buttonEditStylesGlobal = UniteFunctionsRev::getHtmlLink("javascript:void(0)", "<i class=\"revicon-palette\"></i>编辑全局样式","button_edit_css_global","button-primary revblue");
	...
	if($sliderTemplate == "true"){
		$addHtmlTextarea .= UniteFunctionsRev::getHtmlLink("javascript:void(0)", "插入媒体","linkInsertTemplate","disabled revblue button-primary");
	}
	$addHtmlTextarea .= UniteFunctionsRev::getHtmlLink("javascript:void(0)", "插入按钮","linkInsertButton","disabled revblue button-primary");
	...
	$layerSettings->addTextBox("layer_speed", "","开始时长",$params);
	$layerSettings->addTextBox("layer_splitdelay", "10","分离延迟",$paramssplit);
	...
	$layerSettings->addTextBox("layer_alt", "","Alt文本",array("hidden"=>true, "class"=>"area-alt-params"));
