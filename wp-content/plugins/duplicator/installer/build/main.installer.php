...
<?php if (false) : ?>
    ...
    <html>
        <head>
            ...
            <title>错误: PHP没有运行</title>
        </head>
        <body>
            <h2>错误: PHP没有运行</h2>
            <p>Duplicator需要您的服务器运行PHP. 您的服务器没有安装PHP, 或PHP被关闭.</p>
        </body>
    </html>
<?php endif; ?> 
		...
		<tr>
			...
			<td style="white-space:nowrap; text-align:right">
				<select id="dup-hlp-lnk">
					<option value="null"> - 在线资源 -</option>
					<option value="http://lifeinthegrid.com/duplicator-docs">&raquo; 知识</option>
					<option value="http://lifeinthegrid.com/duplicator-guide">&raquo; 用户指南</option>
					<option value="http://lifeinthegrid.com/duplicator-faq">&raquo; 普通FAQs</option>
					<option value="http://lifeinthegrid.com/duplicator-hosts">&raquo; 支持主机</option>
				</select>
			</td>
		</tr>
		<tr>
				...
				<?php else : ?>
					...
					<div id="dup-wiz">
						<div id="dup-wiz-steps">
							<div class="<?php echo $step1CSS; ?>"><a><span>1</span> 部署</a></div>
							<div class="<?php echo $step2CSS; ?>"><a><span>2</span> 更新 </a></div>
							<div class="<?php echo $step3CSS; ?>"><a><span>3</span> 测试 </a></div>
						</div>
					</div>
				<?php endif; ?>
