...
<form id='dup-step2-input-form' method="post" class="content-form">
	...
	<div class="title-header">老的设置</div>
	<table class="table-inputs-step2">
		<tr valign="top">
			...
			<td>
				...
				<a href="javascript:Duplicator.editOldURL()" id="edit_url_old" style="font-size:12px">编辑</a>		
			</td>
		</tr>
		<tr valign="top">
			<td>Path</td>
			<td>
				...
				<a href="javascript:Duplicator.editOldPath()" id="edit_path_old" style="font-size:12px">编辑</a>		
			</td>
		</tr>
	</table>

	<div class="title-header" style="margin-top:8px">新的设置</div>
	<table class="table-inputs-step2">		
		<tr>
			<td style="width:80px">URL</td>
			<td>
				<input type="text" name="url_new" id="url_new" value="<?php echo $GLOBALS['FW_URL_NEW'] ?>" />
				<a href="javascript:Duplicator.getNewURL('url_new')" style="font-size:12px">获取</a>
			</td>
		</tr>
		<tr>
			<td>Path</td>
	...
	<!-- ==========================
    CREATE NEW USER -->
	<a href="javascript:void(0)" onclick="$('#dup-step2-user-opts').toggle(0)"><b>新管理员帐户...</b></a>
	<div id='dup-step2-user-opts' style="display:none;">
	<table class="table-inputs-step2" style="margin-top:7px">
		<tr><td colspan="2"><i style="color:gray;font-size: 11px">这个特色是可选的.  如果用户名已经存在帐户不会被创建和更新.</i></td></tr>
		<tr>
			<td>用户名 </td>
	...
	<!-- ==========================
    ADVANCED OPTIONS -->
	<a href="javascript:void(0)" onclick="$('#dup-step2-adv-opts').toggle(0)"><b>高级设置...</b></a>
	<div id='dup-step2-adv-opts' style="display:none;">
		<table style="width: 100%;">
			<tr>
				<td valign="top" style="width:80px">站点URL</td>
				<td>
					<input type="text" name="siteurl" id="siteurl" value="" />
					<a href="javascript:Duplicator.getNewURL('siteurl')" style="font-size:12px">获取</a><br/>
				</td>
			</tr>
		</table><br/>
		...
		<input type="checkbox" name="postguid" id="postguid" value="1" /> <label for="postguid">保留文章GUID不改变</label><br/>
		
		<input type="checkbox" name="fullsearch" id="fullsearch" value="1" /> <label for="fullsearch">启用完全搜索 <small>(较慢)</small> </label><br/>
		<br/><br/><br/><br/>	
...
<form id='dup-step2-result-form' method="post" class="content-form" style="display:none">
	...
	<div id="ajaxerr-area" style="display:none">
		...
		<div style="padding: 0px 10px 10px 10px;">
			<div id="ajaxerr-data">在执行数据替代发生了未知错误。  请查看installer-log.txt文件了解详情。</div>
